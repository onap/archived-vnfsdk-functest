...
package org.openo.vnfsdk.functest.scriptmgr;
...
import org.openo.vnfsdk.functest.responsehandler.TestResultMap;
...
public class ScriptManager {
    ...
    public Response executeFunctionTest(String functestEnvId, String uploadId, String frameworktype) {
    ...
    public Response queryResultByFuncTest(UUID instanceId) {
        LOGGER.info("Query functest Result by ID." + instanceId);
        // Query VNF Function test result by function test ID
        return VnfFuncTestResponseHandler.getInstance().getResponseByFuncTestId(instanceId.toString());
    }
